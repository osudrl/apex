...
def env_factory(path, traj="walking", simrate=50, phase_based=False, clock_based=True, state_est=True, dynamics_randomization=True, mirror=False, no_delta=False, ik_baseline=False, learn_gains=False, reward=None, history=0, fixed_speed=None, **kwargs):
    ...
    if path in ['Cassie-v0', 'CassieMin-v0', 'CassiePlayground-v0', 'CassieStandingEnv-v0', 'CassieNoaccelFootDistOmniscient', 'CassieFootDist', 
        ...
        elif path == "CassieEnv_mjvel":
            env_fn = partial(CassieEnv_mjvel, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_filtervel":
            env_fn = partial(CassieEnv_filtervel, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_accel_nopelvel":
            env_fn = partial(CassieEnv_accel_nopelvel, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_mj":
            env_fn = partial(CassieEnv_mj, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_accel_nofy_nojoint":
            env_fn = partial(CassieEnv_accel_nofy_nojoint, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_accel_nofy":
            env_fn = partial(CassieEnv_accel_nofy, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_mj_accel":
            env_fn = partial(CassieEnv_mj_accel, simrate=simrate, dynamics_randomization=dynamics_randomization, reward=reward, history=history)
        elif path == "CassieEnv_accel_nofy_pole":
