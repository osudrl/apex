...
def speedmatch_footheightsmoothforce_footorient_hiprollyawvel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, 0, 0])
    ...
    reward = .2*np.exp(-forward_diff) + .1*np.exp(-orient_diff) \
                + .05*np.exp(-straight_diff) + .05*np.exp(-y_vel) \
                + .15*np.exp(-self.l_foot_cost_smooth_force) + .15*np.exp(-self.r_foot_cost_smooth_force) \
                + .05*np.exp(-self.l_foot_orient) + .05*np.exp(-self.r_foot_orient) \
                + .05*np.exp(-self.hiproll_cost) + .05*np.exp(-self.hipyaw_vel) \
...
def speedmatch_footnoheight_footorient_hiprollyawvel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, 0, 0])
    ...
    reward = .2*np.exp(-forward_diff) + .1*np.exp(-orient_diff) \
                + .05*np.exp(-straight_diff) + .05*np.exp(-y_vel) \
                + .15*np.exp(-self.l_foot_cost_noheight) + .15*np.exp(-self.r_foot_cost_noheight) \
                + .05*np.exp(-self.l_foot_orient) + .05*np.exp(-self.r_foot_orient) \
                + .05*np.exp(-self.hiproll_cost) + .05*np.exp(-self.hipyaw_vel) \
                + .05*np.exp(-self.act_cost) + 0.05*np.exp(-self.torque_penalty)
...
def sidespeedmatch_footnoheight_footorient_hiprollyawvel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, self.side_speed, 0])
    forward_diff = np.abs(qvel[0] - speed_targ[0])
    orient_diff = 1 - np.inner(orient_targ, qpos[3:7]) ** 2
    # orient_diff = np.linalg.norm(qpos[3:7] - np.array([1, 0, 0, 0]))
    y_vel = np.abs(qvel[1] - speed_targ[1])
...
def speedmatch_footlinclock_footorient_hiprollyawvel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, 0, 0])
...
def speedmatch_footlinclock_footorient_stablepel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, 0, 0])
...
def sidespeedmatch_footlinclock_footorient_hiprollyawvelact_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, self.side_speed, 0])
    ...
    reward = .2*np.exp(-forward_diff) + .1*np.exp(-orient_diff) \
                + .1*np.exp(-y_vel) \
                + .1*np.exp(-self.l_foot_cost_linclock) + .1*np.exp(-self.r_foot_cost_linclock) \
                + .05*np.exp(-self.l_foot_orient) + .05*np.exp(-self.r_foot_orient) \
                + .05*np.exp(-self.hiproll_cost) + 0.05*np.exp(-self.hiproll_act) \
                + .05*np.exp(-self.hipyaw_vel) + 0.05*np.exp(-self.hipyaw_act) \
                + .05*np.exp(-self.act_cost) + 0.05*np.exp(-self.torque_penalty)
...
def sidespeedmatch_footlinclock_footorient_stablepel_smoothact_torquecost_reward(self):
    qpos = np.copy(self.sim.qpos())
    qvel = np.copy(self.sim.qvel())
    orient_targ = np.array([1, 0, 0, 0])
    speed_targ = np.array([self.speed, 0, 0])
