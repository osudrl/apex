    ...
    def step(self, action, return_omniscient_state=False, f_term=0):
        ...
        for _ in range(self.simrate):
            ...
            if self.no_delta:
                ...
                lpos, rpos = self.get_ref_foot_state(self.phase+1)
                left_stance  = 1 - lpos[2] / self.trajectory.lpos_zmax
                right_stance = 1 - rpos[2] / self.trajectory.rpos_zmax
                self.l_foot_cost_smooth += (1-left_stance)*l_height_cost + left_stance*l_ground_cost
                self.r_foot_cost_smooth += (1-right_stance)*r_height_cost + right_stance*r_ground_cost
