...
class CassieEnv_mj_accel(CassieEnv_clean):
    ...
    def get_full_state(self):
        ...
        if self.true_state:
            ...
            new_transAccel = self.cassie_state.pelvis.translationalAcceleration[:]
        ...
        # new_transAccel = rotate_by_quaternion(new_transAccel, iquaternion)
        # rot_vel = qvel[3:6]
        # motor_pos = qpos[self.pos_idx]
        # motor_vel = qvel[self.vel_idx]
        # joint_pos = qpos[[15, 16, 29, 30]]
        ...
        #     new_orient,                                 # pelvis orientation
        #     motor_pos,                                     # actuated joint positions
        #     new_transAccel,                       # pelvis translational velocity
        #     rot_vel,                          # pelvis rotational velocity 
        #     motor_vel,                                     # actuated joint velocities
