...
class CassiePlayground:
  ...
  def reset(self):
      ...
      self.command_counter = random.randint(0, self.command_traj.trajlen - 1)
  ...
  def get_full_state(self):
      ...
      # Update speed # TODO: need to add phase_add here because missions are 30 Hz?
      self.speed = self.command_traj.speed_cmd[int(self.command_counter)]
      ...
      orient_add = self.command_traj.orient[int(self.command_counter)] - self.cassie_state.pelvis.orientation[2]
      ...
      self.command_traj.prev_orient = self.command_traj.orient[int(self.command_counter)]
