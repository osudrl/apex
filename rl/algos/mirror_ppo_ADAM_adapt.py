    ...
    def train(self,
        ...
        for itr in range(n_itr):
            ...
            if logger is not None:
                ...
                test = self.sample_parallel(env_fn, policy, 800 // eval_proc, 400, deterministic=True)
                ...
                if type(logger) is Logger:
                    ...
                    logger.add_scalar("Misc/Mirror Loss", mirror_loss, itr)
